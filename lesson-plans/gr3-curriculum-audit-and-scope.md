...
- Grade 3 Life Science Unit 1 refcards for Lessons 3–6 are now present in repo but still need live verification
- Grade 3 Life Science Unit 1 quiz is now present in repo but still needs live verification
...
- verify/preserve deeper preview behavior on LS1 Lessons 3–6 through publish
- wire real Remarq document IDs for LS1 lessons, refcards, and quiz
- publish the repo-ready LS1 navigation/catalog updates so LS1 Lessons 3–6 and the LS1 quiz are publicly discoverable where intended
- publish and verify the public/live LS1 URLs
...
| Life Science | `3-LS1 Unit 1` | L3 | lesson + support exist in repo | keep lesson/refcard pair | `lesson-plans/gr3-ls1-unit1-lesson3-plant-life-cycles-and-seeds.html` | `lesson-plans/gr3-ls1-unit1-refcard-lesson3-plant-life-cycles-and-seeds.html` | `lesson-plans/gr3-ls1-unit1-quiz.html` | placeholder/pending real ID | verify lesson still locks from `Materials` after final publish prep | Rachel+Margaret round 1 recorded for lesson; support-asset review addendum now recorded | `https://littlelabcoats.co/lesson-plans/gr3-ls1-unit1-lesson3-plant-life-cycles-and-seeds.html` | repo navigation updated; public site still needs live verification |
| Life Science | `3-LS1 Unit 1` | L4 | lesson + support exist in repo | keep lesson/refcard pair | `lesson-plans/gr3-ls1-unit1-lesson4-animal-life-cycles-and-metamorphosis.html` | `lesson-plans/gr3-ls1-unit1-refcard-lesson4-animal-life-cycles-and-metamorphosis.html` | `lesson-plans/gr3-ls1-unit1-quiz.html` | placeholder/pending real ID | verify lesson still locks from `Materials` after final publish prep | Rachel+Margaret round 1 recorded for lesson; support-asset review addendum now recorded | `https://littlelabcoats.co/lesson-plans/gr3-ls1-unit1-lesson4-animal-life-cycles-and-metamorphosis.html` | repo navigation updated; public site still needs live verification |
| Life Science | `3-LS1 Unit 1` | L5 | lesson + support exist in repo | keep lesson/refcard pair | `lesson-plans/gr3-ls1-unit1-lesson5-comparing-life-cycle-patterns.html` | `lesson-plans/gr3-ls1-unit1-refcard-lesson5-comparing-life-cycle-patterns.html` | `lesson-plans/gr3-ls1-unit1-quiz.html` | placeholder/pending real ID | verify lesson still locks from `Materials` after final publish prep | Rachel+Margaret round 1 recorded for lesson; support-asset review addendum now recorded | `https://littlelabcoats.co/lesson-plans/gr3-ls1-unit1-lesson5-comparing-life-cycle-patterns.html` | repo navigation updated; public site still needs live verification |
| Life Science | `3-LS1 Unit 1` | L6 | lesson + support exist in repo | keep lesson/refcard pair | `lesson-plans/gr3-ls1-unit1-lesson6-model-and-explain-a-life-cycle.html` | `lesson-plans/gr3-ls1-unit1-refcard-lesson6-model-and-explain-a-life-cycle.html` | `lesson-plans/gr3-ls1-unit1-quiz.html` | placeholder/pending real ID | verify lesson still locks from `Materials` after final publish prep | Rachel+Margaret round 1 recorded for lesson; support-asset review addendum now recorded | `https://littlelabcoats.co/lesson-plans/gr3-ls1-unit1-lesson6-model-and-explain-a-life-cycle.html` | repo navigation updated; public site still needs live verification |
| Life Science | `3-LS1 Unit 1` | Unit support | repo-complete, not live-verified | keep companion set and publish/verify | n/a | `lesson-plans/gr3-ls1-unit1-refcard-lesson3-plant-life-cycles-and-seeds.html`; `lesson-plans/gr3-ls1-unit1-refcard-lesson4-animal-life-cycles-and-metamorphosis.html`; `lesson-plans/gr3-ls1-unit1-refcard-lesson5-comparing-life-cycle-patterns.html`; `lesson-plans/gr3-ls1-unit1-refcard-lesson6-model-and-explain-a-life-cycle.html` | `lesson-plans/gr3-ls1-unit1-quiz.html` | all pending real IDs | quiz behavior aligned to Grade 3 quiz pattern | batch review now includes support-asset review addendum; live verification still required | `https://littlelabcoats.co/lesson-plans/gr3-ls1-unit1-quiz.html` | repo navigation updated; add any public support exposure only if intentionally surfaced |
